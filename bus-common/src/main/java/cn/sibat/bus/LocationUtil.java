...
public class LocationUtil {
    ...
    public static double distance(double lon1, double lat1, double lon2, double lat2) {
        ...
        return 2 * Math.atan2(Math.sqrt(s), Math.sqrt(1 - s)) * EARTH_RADIUS * 1000;
    }
     ...
     * @param lon2 经度2
     * @param lat2 纬度2
     * @return 距离（度量而已，非实际球面距离）
     */
    public static double manhattanDistance(double lon1, double lat1, double lon2, double lat2) {
